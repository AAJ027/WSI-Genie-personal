...
class TransLayer(nn.Module):
    ...
    def forward(self, x):
        val, attn = self.attn(self.norm(x))
        x = x + val
        return x, attn
...
class TransMIL(nn.Module):
    def __init__(self,  n_classes, input_size=1024, head_fusion='mean'):
    ...
    def forward(self, feature):
        ...
        h = feature #[B, n, input_size] -> [B, n, 512]
        
        h = self._fc1(h) #[B, n, 512] -> [B, n, 512]
        ...
        if attn0 is not None and attn1 is not None:
